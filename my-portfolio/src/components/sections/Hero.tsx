    ...
    >
      ...
      <div className='max-w-4xl mx-auto text-center relative z-10'>
        ...
        <div className='mb-6 sm:mb-8 flex justify-center'>
          ...
          >
            <div className='w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-full bg-gradient-primary flex items-center justify-center text-2xl sm:text-3xl md:text-4xl font-bold'>
              <img
                alt='Pablo Amico'
                src='/logo/logopablo.png'
                width={398}
                height={536}
                fetchPriority='high'
                className='object-contain w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 p-2'
              />
            </div>
          </GlassCard>
        </div>
        ...
        <div className='space-y-4 sm:space-y-6'>
          ...
          <GlassCard
            variant='default'
            className='p-4 sm:p-6 max-w-2xl mx-auto animate-fade-in-up delay-200 '
          >
        ...
        {/* Scroll Indicator */}
        <div className='absolute bottom-8 right-1/2 transform -translate-x-1/2 animate-bounce' aria-hidden='true'>
